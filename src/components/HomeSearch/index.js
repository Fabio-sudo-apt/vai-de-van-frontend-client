...
import { HomeSearchInto, HomeSearchTop, HomeSearchWrapper, DivForm, ContainerTickets, TicketWrapper, divBotao } from "./styled";
...
const HomeSearch = () => {
  ...
  const Carregar = async e => {
    ...
    for (let i = 0; i <= viagem.length - 1; i++) {
      if (travel.origem === viagem[i].nome && travel.destino === viagem[i].destino) {
  ...
  function verificaData() {
    ...
    let dataCampo = new Date(partesCampo[2], partesCampo[1] - 1, partesCampo[0]);
          ...
          <form onSubmit={Carregar}>
            <DivForm>
              <FormControl variant="filled" sx={{ m: 1, minWidth: 120 }}>
                <InputLabel id="demo-simple-select-filled-label">Origem</InputLabel>
                <Select
              ...
              <FormControl variant="filled" sx={{ m: 1, minWidth: 120 }}>
                <InputLabel id="demo-simple-select-filled-label">Destino</InputLabel>
                <Select
                  labelId="demo-simple-select-filled-label"
                  id="demo-simple-select-filled"
                  name="destino"
              ...
              <button type="submit" onClick={() => resetState()}>Enviar</button>
            </DivForm>
          </form>
        </HomeSearchInto>
      </HomeSearchWrapper>
